<?php /* zig - dont display author or comments in post details */ ?>
<?php global $meta_sep, $be_themes_data; ?>
<nav class="post-nav meta-font secondary_text">
	<?php if($be_themes_data['blog_style'] != 'style7'){?>
	<ul class="clearfix">
		<?php /* zig xout <li class="post-meta post-author"><?php _e('Posted By :','oshin'); ?> <?php echo get_the_author(); ?><span class="post-meta-sep">/</span></li>
